...
Similar to Responder, for powershell__
PS C:\> Import-Module .\Inveigh.ps1__
PS C:\> (Get-Command Invoke-Inveigh).Parameters__
PS C:\> Invoke-Inveigh Y -NBNS Y -ConsoleOutput Y -FileOutput Y__
